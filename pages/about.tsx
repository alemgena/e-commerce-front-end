          ...
          <div className=" h-pv-15 h-ph-15 h-mv-20 b-static-page">
            <div className="h-p-20">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="p-6">
                  <h1 className="text-xl font-bold">LIYU DIGITAL TECHNOLOGY</h1>
                  <p className="text-xl">
                    is an Ethiopian technology company specializing in e-
                    commerce, retail, internet and technology. Founded on 2022
                    in Addis Ababa, the company provides consumer to consumer
                    (C2C), business to consumer (B2C), and business to business
                    (B2B) sales services via web portal and mobile application,
                    as well as electronic payment services, shopping search
                ...
                <div className=" p-6">
                  ...
                  <p className="text-xl">
                    the messages and calls from your clients! If everything is
                    ok with your advert, it’ll be on liyu in a couple of hours
                    after sending to moderation. We’ll send you a letter and
                    notification when your advert goes live. Check your messages
                    and be ready to earn money!
                  </p>
                  <button
                    onClick={() => router.push('/sell/products/create')}
                  ...
                  <div className="p-0">
                    ...
                    <ol className="">
                      <li className="mb-2">
                        ...
                        <p className="text-xl">
                          Find what you need using search panel and filters. We
                          have over a million adverts, choose exactly what you
                          are looking for.
                        </p>
                      </li>
                      <li className="mb-2">
                      ...
                      <li className="mb-2 text-xl">
                        ...
                        <p className="text-xl">
                          We check our sellers carefully, but it’s always better
                          to check twice, right? Meet a seller in public place
                          and be sure to pay only after collecting your item.
                        </p>
                      </li>
                      <li className="mb-2 mt-2">
                        ...
                        <p className="text-xl">
                          ...
                          feedback will be published online on the seller’s page
                          and will be very helpful for other buyers. Let’s build
                          a safe and professional business community together!
                        </p>
                      </li>
                    </ol>
                  </div>
                ...
                <div id="security">
                  ...
                  <div className="bg-gray-100 p-4">
                    ...
                    <p className="text-xl">
                      We are highly focused on security and can solve any issues
                      in short terms.
                    </p>
                    <p className="text-xl">
                      That's why we kindly ask you to leave a review after
                      purchasing. If you have any problems with a seller, please
                      report it to us and our team will check the seller as soon
                      as possible.
                    </p>
                  </div>
                  <div className="bg-gray-100 p-4">
                    <p className="text-xl font-bold">Personal Safety Tips:</p>
